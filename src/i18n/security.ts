const security = {
  en: {
    ...
    dataPrivacy: {
      ...
      piiItems: [
        ...
        'Booking history and spot purchase records',
        'Payment metadata (Stripe handles card data — we never see or store card numbers)',
        'IP addresses and user agents (security logging, retained 90 days)',
      ],
      retentionTitle: 'Data Retention',
      retentionItems: [
        'Account data: retained while the account is active, deleted on request',
        'Booking records: retained for 12 months for business reporting',
        'Audit logs: retained for 12 months, auto-deleted via TTL',
        'Login attempts: retained for 90 days, auto-deleted via TTL',
        'Guest booking PII: encrypted at rest with AES-256-GCM',
      ],
      gdprTitle: 'Your Rights (GDPR)',
      gdprDesc: 'As a data subject under GDPR, you have the right to access, rectify, erase, restrict processing, data portability, and object to processing. Contact us to exercise any of these rights.',
    ...
    infrastructure: {
      ...
      services: [
        ...
        { name: 'IoT Gateway', provider: 'Railway', detail: 'Shelly device integration for gate control' },
      ],
  ...
  pt: {
    ...
    dataPrivacy: {
      ...
      piiItems: [
        'Nome e endere\u00e7o de email (registo de conta)',
        'N\u00famero de telefone (opcional, para notifica\u00e7\u00f5es de reserva)',
        'Hist\u00f3rico de reservas e registos de compra de lugares',
        'Metadados de pagamento (o Stripe processa os dados do cart\u00e3o \u2014 nunca vemos nem armazenamos n\u00fameros de cart\u00e3o)',
        'Endere\u00e7os IP e user agents (registo de seguran\u00e7a, retido 90 dias)',
      ],
      retentionTitle: 'Reten\u00e7\u00e3o de Dados',
      retentionItems: [
        'Dados da conta: retidos enquanto a conta estiver ativa, eliminados a pedido',
        'Registos de reserva: retidos por 12 meses para relat\u00f3rios',
        'Registos de auditoria: retidos por 12 meses, eliminados automaticamente',
        'Tentativas de login: retidas por 90 dias, eliminadas automaticamente',
        'PII de reservas de convidados: encriptado em repouso com AES-256-GCM',
      ],
      gdprTitle: 'Os Seus Direitos (RGPD)',
      gdprDesc: 'Enquanto titular de dados ao abrigo do RGPD, tem o direito de acesso, retifica\u00e7\u00e3o, elimina\u00e7\u00e3o, limita\u00e7\u00e3o do tratamento, portabilidade e oposi\u00e7\u00e3o. Contacte-nos para exercer qualquer um destes direitos.',
    ...
    infrastructure: {
      ...
      services: [
        ...
        { name: 'Gateway IoT', provider: 'Railway', detail: 'Integra\u00e7\u00e3o de dispositivos Shelly para controlo de port\u00f5es' },
      ],
  ...
  es: {
    ...
    dataPrivacy: {
      ...
      retentionItems: ['Datos de cuenta: mientras est\u00e9 activa', 'Registros de reserva: 12 meses', 'Registros de auditor\u00eda: 12 meses', 'Intentos de inicio de sesi\u00f3n: 90 d\u00edas', 'PII de invitados: cifrado con AES-256-GCM'],
      gdprTitle: 'Sus Derechos (RGPD)',
      gdprDesc: 'Tiene derecho a acceso, rectificaci\u00f3n, supresi\u00f3n, limitaci\u00f3n, portabilidad y oposici\u00f3n.',
    ...
    infrastructure: {
      ...
      services: [
        ...
        { name: 'Gateway IoT', provider: 'Railway', detail: 'Integraci\u00f3n Shelly' },
      ],
  ...
  de: {
    ...
    dataPrivacy: {
      ...
      retentionItems: ['Kontodaten: solange aktiv', 'Buchungen: 12 Monate', 'Audit-Protokolle: 12 Monate', 'Login-Versuche: 90 Tage', 'Gast-PII: AES-256-GCM verschl\u00fcsselt'],
      gdprTitle: 'Ihre Rechte (DSGVO)',
      gdprDesc: 'Sie haben das Recht auf Auskunft, Berichtigung, L\u00f6schung, Einschr\u00e4nkung, Daten\u00fcbertragbarkeit und Widerspruch.',
    ...
    infrastructure: {
      ...
      services: [
        ...
        { name: 'IoT-Gateway', provider: 'Railway', detail: 'Shelly-Integration' },
      ],
  ...
  fr: {
    ...
    dataPrivacy: {
      ...
      retentionItems: ['Donn\u00e9es de compte : tant que le compte est actif', 'R\u00e9servations : 12 mois', 'Journaux d\'audit : 12 mois', 'Tentatives de connexion : 90 jours', 'PII invit\u00e9s : chiffr\u00e9 AES-256-GCM'],
      gdprTitle: 'Vos Droits (RGPD)',
      gdprDesc: 'Vous avez le droit d\'acc\u00e8s, de rectification, d\'effacement, de limitation, de portabilit\u00e9 et d\'opposition.',
    ...
    infrastructure: {
      ...
      services: [
        ...
        { name: 'Passerelle IoT', provider: 'Railway', detail: 'Int\u00e9gration Shelly' },
      ],
  ...
  zh: {
    ...
    dataPrivacy: {
      ...
      retentionTitle: '\u6570\u636e\u4fdd\u7559',
      retentionItems: ['\u8d26\u6237\u6570\u636e\uff1a\u6d3b\u8dc3\u671f\u95f4\u4fdd\u7559', '\u9884\u8ba2\u8bb0\u5f55\uff1a12\u4e2a\u6708', '\u5ba1\u8ba1\u65e5\u5fd7\uff1a12\u4e2a\u6708', '\u767b\u5f55\u5c1d\u8bd5\uff1a90\u5929', '\u8bbf\u5ba2PII\uff1aAES-256-GCM\u52a0\u5bc6'],
      gdprTitle: '\u60a8\u7684\u6743\u5229\uff08GDPR\uff09',
      gdprDesc: '\u60a8\u6709\u6743\u8bbf\u95ee\u3001\u66f4\u6b63\u3001\u5220\u9664\u3001\u9650\u5236\u5904\u7406\u3001\u6570\u636e\u53ef\u79fb\u690d\u6027\u548c\u53cd\u5bf9\u3002',
    ...
    infrastructure: {
      ...
      services: [
        ...
        { name: 'IoT\u7f51\u5173', provider: 'Railway', detail: 'Shelly\u96c6\u6210' },
      ],
  ...
  ar: {
    ...
    dataPrivacy: {
      ...
      retentionItems: ['\u0628\u064a\u0627\u0646\u0627\u062a \u0627\u0644\u062d\u0633\u0627\u0628: \u0637\u0648\u0627\u0644 \u0641\u062a\u0631\u0629 \u0627\u0644\u0646\u0634\u0627\u0637', '\u0633\u062c\u0644\u0627\u062a \u0627\u0644\u062d\u062c\u0632: 12 \u0634\u0647\u0631\u0627\u064b', '\u0633\u062c\u0644\u0627\u062a \u0627\u0644\u062a\u062f\u0642\u064a\u0642: 12 \u0634\u0647\u0631\u0627\u064b', '\u0645\u062d\u0627\u0648\u0644\u0627\u062a \u0627\u0644\u062f\u062e\u0648\u0644: 90 \u064a\u0648\u0645\u0627\u064b', 'PII \u0627\u0644\u0636\u064a\u0648\u0641: \u0645\u0634\u0641\u0631 AES-256-GCM'],
      gdprTitle: '\u062d\u0642\u0648\u0642\u0643 (GDPR)',
      gdprDesc: '\u0644\u062f\u064a\u0643 \u0627\u0644\u062d\u0642 \u0641\u064a \u0627\u0644\u0648\u0635\u0648\u0644 \u0648\u0627\u0644\u062a\u0635\u062d\u064a\u062d \u0648\u0627\u0644\u062d\u0630\u0641 \u0648\u062a\u0642\u064a\u064a\u062f \u0627\u0644\u0645\u0639\u0627\u0644\u062c\u0629 \u0648\u0627\u0644\u0646\u0642\u0644 \u0648\u0627\u0644\u0627\u0639\u062a\u0631\u0627\u0636.',
    ...
    infrastructure: {
      ...
      services: [
        ...
        { name: '\u0628\u0648\u0627\u0628\u0629 IoT', provider: 'Railway', detail: '\u062a\u0643\u0627\u0645\u0644 Shelly' },
      ],
